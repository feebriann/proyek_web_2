<x-app-layout>
        ...
        <div class="py-12 dark-grunge-bg min-h-screen relative overflow-hidden font-sans selection:bg-red-600 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-10">
                ...
                <div class="flex justify-end gap-4 mb-8 relative z-50">
                    @guest
                        <a href="{{ route('login') }}" class="slanted-button bg-black border border-red-600 text-red-600 px-8 py-2.5 font-black uppercase text-xs tracking-widest hover:bg-red-600 hover:text-black transition-colors shadow-[4px_4px_0_rgba(220,38,38,0.3)]">
                            LOGIN
                        </a>
                        <a href="{{ route('register') }}" class="slanted-button bg-red-600 text-black border border-red-600 px-8 py-2.5 font-black uppercase text-xs tracking-widest glitch-hover transition-colors shadow-[4px_4px_0_rgba(220,38,38,0.3)]">
                            CREATE_ACCOUNT
                        </a>
                    @endguest
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 relative z-50">
                    ...
                    <div class="group relative bg-[#0a0a0a] border border-zinc-800 p-2 transition-all duration-300 hover:border-red-600 flex flex-col h-full slanted-edge hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(220,38,38,0.15)] hover:bg-[#0f0f0f]">
                        ...
                        <div class="relative w-full h-60 mb-4 bg-black overflow-hidden slanted-edge border border-zinc-900 pointer-events-none">
                            ...
                            <img src="{{ $album->cover_image }}" alt="Cover" class="w-full h-full object-cover filter contrast-125 grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-500">
                        ...
                        <div class="flex-grow flex flex-col px-3 pb-2 relative">
                            <div class="text-zinc-600 text-[8px] font-black mb-2 tracking-[0.2em] uppercase flex justify-between border-b border-zinc-800 pb-2 pointer-events-none">
                                <span>[TRK-{{ sprintf('%03d', $album->id) }}]</span>
                            ...
                            <h3 class="impact-font text-white text-xl uppercase leading-none mb-1.5 mt-1 tracking-wider drop-shadow-[1px_1px_0px_#dc2626] pointer-events-none">
                                <span class="text-zinc-700 font-mono text-xs mr-1">></span>{{ $album->title }}
                            </h3>
                            
                            <p class="text-zinc-400 text-xs mb-5 font-bold uppercase truncate tracking-wide pointer-events-none" title="{{ $album->artist }}">
                                {{ $album->artist }}
                            </p>
                            
                            <!-- Tombol Aksi di Kartu -->
                            <div class="mt-auto flex gap-2 w-full z-50">
                                <a href="{{ route('albums.show', $album->id) }}" class="hardcore-link flex-[2] text-center bg-transparent border border-zinc-700 text-zinc-300 py-3 font-black text-[10px] uppercase tracking-widest transition-all duration-200 glitch-hover slanted-button relative overflow-hidden group/btn">
                                ...
                                @if(Auth::check() && Auth::user()->role == 'admin')
                                <a href="{{ route('albums.edit', $album->id) }}" class="hardcore-link flex-1 text-center bg-zinc-950 border border-zinc-800 text-zinc-500 py-3 px-4 font-black text-[10px] uppercase tracking-widest transition-all duration-200 hover:bg-zinc-800 hover:text-red-500 hover:border-red-900 slanted-button">
                                    EDIT
                                </a>
                                @endif
                            </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const playlist = [
                { title: "> BGM_TRK_01", file: "{{ asset('audio/lagu1.mp3') }}" },
                { title: "> BGM_TRK_02", file: "{{ asset('audio/lagu2.mp3') }}" },
                { title: "> BGM_TRK_03", file: "{{ asset('audio/lagu3.mp3') }}" },
                { title: "> BGM_TRK_04", file: "{{ asset('audio/lagu4.mp3') }}" }
            ];
