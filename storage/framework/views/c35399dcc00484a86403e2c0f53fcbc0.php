...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12 dark-grunge-bg min-h-screen font-sans selection:bg-red-600 selection:text-white relative overflow-hidden">
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-4">
            <a href="<?php echo e(route('albums.index')); ?>" class="inline-flex items-center mb-8 text-zinc-500 hover:text-white font-black text-sm uppercase tracking-widest transition-all bg-zinc-900/80 px-4 py-2 border border-zinc-800 slanted-button">
            ...
            <div class="bg-zinc-950/80 backdrop-blur-md border-2 border-zinc-800 p-8 md:p-12 slanted-edge shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative">
                ...
                <form action="<?php echo e(route('albums.update', $album->id)); ?>" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" name="title" value="<?php echo e($album->title); ?>" class="w-full bg-black border-2 border-zinc-800 focus:border-yellow-500 text-white p-4 font-black uppercase transition-colors focus:ring-0 slanted-edge" required>
                        </div>
                        <div>
                            <label class="block text-zinc-500 text-[10px] font-black mb-3 uppercase tracking-[0.2em]">Artist / Band</label>
                            <input type="text" name="artist" value="<?php echo e($album->artist); ?>" class="w-full bg-black border-2 border-zinc-800 focus:border-yellow-500 text-white p-4 font-black uppercase transition-colors focus:ring-0 slanted-edge" required>
                        </div>
                    </div>
                    
                    <div class="mb-6">
                        <label class="block text-zinc-500 text-[10px] font-black mb-3 uppercase tracking-[0.2em]">Genre Class</label>
                        <input type="text" name="genre" value="<?php echo e($album->genre); ?>" class="w-full bg-black border-2 border-zinc-800 focus:border-yellow-500 text-white p-4 font-black uppercase transition-colors focus:ring-0 slanted-edge" required>
                    </div>
                    
                    <div class="mb-6">
                        <label class="block text-zinc-500 text-[10px] font-black mb-3 uppercase tracking-[0.2em]">Cover Image URL</label>
                        <input type="url" name="cover_image" value="<?php echo e($album->cover_image); ?>" class="w-full bg-black border-2 border-zinc-800 focus:border-yellow-500 text-white p-4 font-mono transition-colors focus:ring-0 slanted-edge" required placeholder="https://...">
                    </div>
                    ...
                    <div class="mb-10 relative">
                        ...
                        <input type="url" name="spotify_link" value="<?php echo e($album->spotify_link); ?>" class="w-full bg-black border-2 border-zinc-800 focus:border-red-600 text-red-500 p-4 font-mono transition-colors focus:ring-0 slanted-edge shadow-[inset_0_0_15px_rgba(220,38,38,0.15)]" required placeholder="https://open.spotify.com/track/...">
                ...
                <form action="<?php echo e(route('albums.destroy', $album->id)); ?>" method="POST" class="mt-4" onsubmit="return confirm('WARNING: Are you sure you want to permanently delete this track?');">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\web-musik\resources\views/albums/edit.blade.php ENDPATH**/ ?>